                        ...
                        <table class="w-full">
                            ...
                            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                @foreach ($interview as $a)
                                    ...
                                    <div id="defaultModal{{ $a->id }}" tabindex="-1"
                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <div
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        data-modal-toggle="defaultModal{{ $a->id }}">
                                    ...
                                    <div id="RatingModal{{ $a->id }}" tabindex="-1"
                                        class="hidden  overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full justify-center items-center flex"
                                        aria-modal="true" role="dialog">
                                        <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                                            <!-- Modal content -->
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <div
                                                    ...
                                                    <button type="button"
                                                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                                        data-modal-toggle="RatingModal{{ $a->id }}">
                                                        <svg aria-hidden="true" class="w-5 h-5" fill="currentColor"
                                                            viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                            <path fill-rule="evenodd"
                                                                d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                                                    ...
                                                    <form method="POST" action="{{ route('review.store') }}"
                                                        ...
                                                        <div>
                                                            ...
                                                            <select name="candidate_id" id="candidate_id"
                                                                ...
                                                                <option class="capitalize"
                                                                    value="{{ $a->interviewees->id }}">
                                                                    {{ $a->interviewees->name }}</option>
                                                            </select>
                                                            @error('candidate_id')
                                                        ...
                                                        <div>
                                                            ...
                                                            <select name="questionnaire_id" id="questionnaire_id"
                                                                class="@error('questionnaire_id') is-invalid @enderror capitalize bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white ">
                                                                <option class="capitalize" value="{{ $a->user->id }}">
                                                                    {{ $a->user->name }}</option>
                                                            </select>
                                                        ...
                                                        <div>
                                                            ...
                                                            <input value="{{ $a->id }}" name="interview_id"
                                                                id="interview_id"
                                                                class="@error('interview_id') is-invalid @enderror capitalize bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white "
                                                                type="hidden">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="rating">
                                                                <input type="radio" name="rating_amount"
                                                                    class="mask mask-star" value="1" />
                                                                <input type="radio" name="rating_amount"
                                                                    class="mask mask-star" value="2" />
                                                                <input type="radio" name="rating_amount"
                                                                    class="mask mask-star" value="3" />
                                                                <input type="radio" name="rating_amount"
                                                                    class="mask mask-star" value="4" />
                                                                <input type="radio" name="rating_amount"
                                                                    class="mask mask-star" value="5" />
                                                            </div>
