            ...
            <div tabindex="0" aria-label="form" class="focus:outline-none w-full bg-white p-10 dark:bg-gray-800">
                ...
                <p tabindex="0"
                    ...
                    <div class="flex flex-col">
                        ...
                        <label class="mb-3 text-sm leading-none text-black dark:text-white">Current-Password</label>
                        <input placeholder="Current-Password" type="password" tabindex="0"
                            aria-label="Enter current password" name="old_password"
                            class="@error('old_password') is-invalid @enderror focus:outline-none focus:ring-2 focus:ring-indigo-400 w-64 bg-gray-100 text-sm font-medium leading-none text-black p-3 border rounded border-gray-200" />
                            @error('old_password')
