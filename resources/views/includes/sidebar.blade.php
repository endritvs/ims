...
<div
        ...
        <ul class="flex flex-col py-4 space-y-1">
            <li class="px-5 hidden md:block">
                ...
                <span class="font-medium text-white relative pl-3 bottom-4 uppercase">{{Auth::user()->company->company_name}}</span>
                    ...
                    <span
                        class="font-medium text-white relative pl-3 bottom-4 uppercase">{{ Auth::user()->name }}</span>
                @endif
            ...
            @if (Auth::user()->role === 'admin')
                <li>
                    <a href="{{ route('intervieweeAttributes.index') }}"
                        class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
                        <span class="inline-flex justify-center items-center ml-4">
            ...
            @endif
            <li>
                <a href="{{ route('interviewees.index') }}" id="dropdownDefault" data-dropdown-toggle="dropdown"
                    class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
                    <span class="inline-flex justify-center items-center ml-4">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z" />
        ...
        <p class="px-5 py-3 hidden md:block text-center text-xs">
            {{ Auth::user()->company->company_name . ' ' . date('Y') }}</p>
    </div>
</div>
