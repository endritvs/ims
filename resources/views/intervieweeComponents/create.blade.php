...
<form class="shadow rounded-md w-[500px]" method="POST" action="{{ route('interviewee.store') }}">
    ...
    <div class="p-4 bg-gray-800">
        ...
        <input type="text" name="name" id="name" autocomplete="given-name" placeholder="Interviewee Type Name"  class="@error('interviewee_types_id') is-invalid @enderror mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
        @error('name')
