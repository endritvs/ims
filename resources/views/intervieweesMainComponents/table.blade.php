...
@section('content')
    <div class="m-0 font-sans text-base antialiased font-normal dark:bg-slate-900 leading-default bg-gray-50 text-slate-500">
        ...
        <main class="relative h-[100vh] transition-all duration-200 ease-in-out xl:ml-68 rounded-xl" style="height: 100vh;">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    @foreach ($intervieweesA as $i)
                        ...
                        <div class="w-full pt-1 mx-auto">
                            <div>
                                <div class="relative min_height flex flex-col w-auto break-words bg-white border-0 shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border">
                                    <div>
                                        ...
                                        <div id="dropdownDots{{ $i->id }}"
                                            ...
                                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                                ...
                                                <li>
                                                    <a data-modal-toggle="editModal{{ $i->id }}" href="#"
                                                        class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Edit</a>
                                                </li>

                                                <li>
                                                    <a data-modal-toggle="deleteUserModal{{ $i->id }}" href="#"
                                                ...
                                                @if (Auth::user()->role == 'interviewer')
                                                    <li>
                                                        <a data-modal-toggle="AddToInterviewModal{{ $i->id }}"
                                                            href="#"
                                    ...
                                    <div class="flex flex-col items-center -mx-3">
                                            ...
                                            <div class="my-4">
                                                <a href="javascript:;">
                                                    @if ($i->img === 'public/noProfilePhoto/nofoto.jpg')
                                                        <img class="mx-auto img_candidate border-2 border-white border-solid rounded-circle"
                                        ...
                                        <h5 class="dark:text-white text-center">{{ $i->name . ' ' . $i->surname }}</h5>
                                    </div>


                                    <div class="p-6 pt-0">
                                        <div class="text-center">
                                            <label class="w-1/2 mx-auto px-2 py-1 font-bold leading-normal text-center text-white align-middle transition-all ease-in border-0 rounded-lg shadow-md cursor-pointer text-xs bg-cyan-500 lg:block tracking-tight-rem hover:shadow-xs hover:-translate-y-px active:opacity-85">
                                    ...
                                    <div class="p-6">
                                        <div class="flex items-center w-full ">
                                            @if (count($exec1) > 1)
                                                @foreach ($exec1 as $rat => $dd)
                                                    @if ($dd->candidate_id === $i['id'])
                                                        <p
                                                            class="bg-blue-100 text-blue-800 text-sm font-semibold inline-flex items-center p-1 rounded dark:bg-blue-200 dark:text-blue-800">
                                                            {{ floatval($dd->rating) }}</p>
                                                        <p class="ml-2 font-medium text-gray-900 dark:text-white">Rating
                                                        </p>
                                                    @break
                                                @endif
                                            @endforeach
                                            @if (!($dd->candidate_id === $i['id']))
                                                ...
                                                <p class="ml-2 font-medium text-gray-900 dark:text-white">Not Yet Rated
                                                </p>
                                                <span
                                                    class="mx-2 w-1 h-1 bg-gray-900 rounded-full dark:bg-gray-500"></span>
                                                <p class="text-sm font-medium text-gray-500 dark:text-gray-400">0
                                                    reviews
                                                </p>
                                            @endif
                                        @endif
                                    ...
                                    <div class="grid grid-cols-1 grid-rows-2 gap-x-8 gap-y-2 w-full ">
                                                ...
                                                <dd class="flex items-center">
                                                    <div
                                                        ...
                                                        <div class="bg-blue-600 h-2.5 rounded dark:bg-blue-500"
                                                            style="width: {{ ($rate == 'No Rating' ? 0 : round(floatval($rate), 1)) * 10 }}%">
                                                        </div>
                                                    </div>
                                                    <span
                                                        class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ round(floatval($rate), 1) }}</span>
                                                </dd>
                                                ...
                                                <dl>
                                                    ...
                                                    <dd class="flex items-center">
                                                        <div
                                                            class="w-full bg-gray-200 rounded h-2.5 dark:bg-gray-700 mr-2">
                                                            <div class="bg-blue-600 h-2.5 rounded dark:bg-blue-500"
                                                                style="width: {{ ($rate == 'No Rating' ? 0 : round(floatval($ar->rating_amount), 1)) * 10 }}%">
                                                            </div>
                                                        </div>
                                                        <span
                                                            class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ round(floatval($ar->rating_amount), 1) }}</span>
                                                    </dd>
                                                </dl>
                                            @endif
                                        @endforeach
                                    ...
                                    <div class="border-black/12.5 rounded-t-2xl p-6 text-center pt-0 pb-6 lg:pt-2 lg:pb-4">
                                        <div class="flex justify-between">
                                            @if (pathinfo($cv[2])['extension'] === 'pdf')
                                                <a href="/storage/cv_path/{{ $cv[2] }}">
                                                    <button type="button"
                                                        class="hidden px-8 py-2 w-full font-bold leading-normal text-center text-white align-middle transition-all ease-in border-0 rounded-lg shadow-md cursor-pointer text-xs bg-blue-500 lg:block tracking-tight-rem hover:shadow-xs hover:-translate-y-px active:opacity-85">
                                                        Show CV</button>
                                                </a>
                                            @else
                                                <a href="/storage/cv_path/{{ $cv[2] }}" download>
                                                    <button type="button"
                                                        class="hidden px-8 py-2 w-full font-bold leading-normal text-center text-white align-middle transition-all ease-in border-0 rounded-lg shadow-md cursor-pointer text-xs bg-blue-700 lg:block tracking-tight-rem hover:shadow-xs hover:-translate-y-px active:opacity-85">Download
                                                        CV</button>
                                                </a>
                                            @endif
                                            <div>
                    ...
                    <div id="defaultModal{{ $i->id }}" tabindex="-1"
                    ...
                    <!-- Quick Add Modal -->
                    <!-- Quick Add Modal -->
                    <div id="quick-add" tabindex="-1"
                        class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
                        <div class="relative p-4 w-full max-w-md h-full md:h-auto">

                            <!-- Modal header -->
                            <div id="profiles"
                                class="w-full relative h-[500px] before:flex before:items-center before:justify-center before:h-full before:text-2xl before:content-['End']">

                                <div id="profile"
                                    class="absolute left-0 top-0 w-full overflow-hidden cursor-pointer select-none rounded-xl shadow-md">
                                    <div id="profile__image" class="h-0 bg-cover pb-[120%] bg-center"
                                    ...
                                    <div id="profile__infos"
                                        class="p-3 absolute bottom-0 w-full bg-gradient-to-t from-gray-800 to-transparent">
                                        <div class="profile__name">Ardit Xhaferi<span id="profile__age"
                                                class="font-normal pl-3">20</span></div>
                                ...
                                <div id="profile"
                                    class="absolute left-0 top-0 w-full overflow-hidden cursor-pointer select-none rounded-xl shadow-md">
                                    <div id="profile__image" class="h-0 bg-cover pb-[120%] bg-center"
                                        style="background-image: url('https://images.unsplash.com/photo-1615900304401-923d2dfd8beb?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NXx8aHVudGVyfGVufDB8fDB8fA%3D%3D&w=1000&q=80');">
                                        <button type="button"
                                            class="float-right text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                            data-modal-toggle="quick-add">
                                            <svg aria-hidden="true" class="w-5 h-5" fill="currentColor"
                                    ...
                                    <div id="profile__infos"
                                        class="p-3 absolute bottom-0 w-full bg-gradient-to-t from-gray-800 to-transparent">
                                        <div class="profile__name">Albert Bislimi<span id="profile__age"
                                                class="font-normal pl-3">22</span></div>
                                ...
                                <div id="profile"
                                    class="absolute left-0 top-0 w-full overflow-hidden cursor-pointer select-none rounded-xl shadow-md">
                                    <div id="profile__image" class="h-0 bg-cover pb-[120%] bg-center"
                                        style="background-image: url('https://images.unsplash.com/photo-1503023345310-bd7c1de61c7d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8aHVtYW58ZW58MHx8MHx8&w=1000&q=80');">
                                        <button type="button"
                                            class="float-right text-gray-400 bg-transparent rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:text-white"
                                            data-modal-toggle="quick-add">
                                            <svg aria-hidden="true" class="w-5 h-5" fill="currentColor"
                                                viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd"
                                    ...
                                    <div id="profile__infos"
                                        class="p-3 absolute bottom-0 w-full bg-gradient-to-t from-gray-800 to-transparent">
                                        <div id="profile__name" class="text-white font-bold text-xl">Qendrim
                                            Rexhepi<span id="profile__age" class="font-normal pl-3">42</span>
                                        </div>
                            ...
                            <div id="bottombar" class="mt-6 flex justify-center items-center gap-6">
                                <div id="bottombar__button"
                                    class="w-16 h-16 rounded-full bg-white p-4 text-red-600 font-black shadow-md duration-4000 hover:cursor-pointer hover:opacity-80">
                                ...
                                <div id="bottombar__button"
                                    class="w-16 h-16 rounded-full bg-white p-4 text-green-700 font-black shadow-md duration-4000 hover:cursor-pointer hover:opacity-80">
                        ...
                        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                            ...
                            <form method="POST" action="{{ route('interview.store') }}"
                                ...
                                <div class="p-6 ">
                                    <div class="">
                                        <div>
                                            ...
                                            <input type="hidden" name="interviewer[]"
                                                value="{{ Auth::user()->id }}" class="hidden bg-gray-700">

                                        </div>
                                        <div>
                                            <label
                                                class="block text-sm font-medium text-gray-900 dark:text-white">Choose
                                                other interviewers (Optional):</label>
                                    ...
                                    <div>
                                        <input type="hidden" name="interviewees_id" value="{{ $i->id }}"
                                            class="hidden bg-gray-700">
                                    </div>


                                    <label class="block text-sm font-medium text-gray-900 dark:text-white">Choose
                                        date</label>
                                    <input type="datetime-local" name="interview_date" min=<?php echo date('Y-m-d') . 'T00:00'; ?>
                                        id="dateId"
            ...
            <div class=" font-medium p-3 flex justify-center">
                {{ $intervieweesA->links() }}
            </div>
        </div>
    </main>
