        ...
        <main class="relative h-[100vh] transition-all duration-200 ease-in-out xl:ml-68 rounded-xl" style="height: 100vh;">
            @include('layouts.navbars.topnav')
                        <div class="text-center pb-16  top-[-50px] sticky z-10">
                            ...
                            <h1
                                class="dark:text-white text-indigo-600 font-bold text-3xl md:text-4xl lg:text-5xl font-heading mb-14 z-0 ">
                                Candidates
                            </h1>
                                    ...
                                    <form action="{{ route('interviewees.sortName') }}" method="GET" role="search"
                                        ...
                                        <button type="submit"
                                            ...
                                            <a class="pl-5 py-2.5 p-0 mr-2 mb-2">A-Z
                                                <i onclick="changeIconC(this)" class="fa-solid fa-arrow-up-long"
                                                    id="AandZ"></i>
                                            </a>
                                        </button>
                                    </form>
                                ...
                                <div
                                    ...
                                    <div class="gap-8 sm:grid sm:grid-cols-1 mt-2">
                                        <div class="mb-4 mt-[-50px]">
                                            @if ($i->img === 'public/noProfilePhoto/nofoto.jpg')
                                                <img class="object-center object-cover rounded-full h-28 w-28"
                                                    src="{{ asset('/noProfilePhoto/' . $link[2]) }}" alt="photo">
                                            @else
                                                <img class="object-center object-cover rounded-full h-28 w-28"
                                                    src="/storage/images/{{ $link[2] }}" alt="photo">
                                            @endif
                                            <p
                                                class="dark:text-white text-indigo-600 font-semibold text-xl capitalize text-center">
                                                {{ $i->name . ' ' . $i->surname }}
                                            </p>
                                    ...
                                    <div class="flex items-center w-full mb-3">
                                        ...
                                        @if (!($dd->candidate_id === $i['id']))
                                            ...
                                            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">0 reviews
                                            </p>
                                        @endif
                                    @endif
                                </div>
                                    ...
                                    <div class="mt-5">
                                        @if (pathinfo($cv[2])['extension'] === 'pdf')
                                            <a data-modal-toggle="defaultModal{{ $i->id }}"
                                                class="px-[10px] bg-blue-500 hover:bg-blue-700 text-white cursor-pointer  p-1 rounded-lg">Show
                                                CV</a>
                                        @else
                                            <a href="/storage/cv_path/{{ $cv[2] }}"
                                                class="px-[10px] bg-blue-500 hover:bg-blue-700 text-white cursor-pointer  p-1 rounded-lg"
                                                download> Download CV</a>
                                        @endif
                                    </div>
                                    <div class="mt-5 pl-5">
                                        <a href="{{ $i->external_cv_path }}"
                                            class="px-[10px] bg-blue-500 hover:bg-blue-700 text-white p-1 rounded-lg">External
                                            Link</a>
                                ...
                                <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-6 space-y-6">
                                            @if (pathinfo($cv[2])['extension'] === 'pdf')
                                                <iframe class="w-full" src={{ '/storage/cv_path/' . $cv[2] }}
                                                    height="600px">
                                                </iframe>
                                            @endif
                                        </div>
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <form method="POST" action="{{ route('interviewees.update', $i->id) }}"
                                            ...
                                            <div class="p-6 text-center">
                                                ...
                                                <p
                                                    class="float-left m-1 text-sm font-medium text-gray-900 dark:text-white">
                                                    Current Image:</p>
                                                <img class="rounded-lg mt-2"
                                                    src="/storage/images/{{ $link[2] }}" width="70px"
                                                    height="70px">
                                ...
                                <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                                    ...
                                    <form method="POST" action="{{ route('interview.store') }}"
                                        ...
                                        <div class="p-6 ">
                                            ...
                                            <div>
                                                <input type="hidden" name="interviewees_id"
                                                    value="{{ $i->id }}" class="hidden bg-gray-700">
                                            </div>
