        ...
        <section class="max-w-6xl mx-auto pb-4 px-4 sm:px-6 lg:px-4 py-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="group relative w-full bg-white dark:bg-slate-850 rounded-lg shadow-lg p-5 mt-4 flex flex-col justify-center items-center transition duration-700 ease-in-out">
                    ...
                    <div class="gap-8 sm:grid sm:grid-cols-2 mb-4">
                        ...
                        <div class="flow-root sm:grid-cols-2 mt-2 text-center">
                            <h2 class="col-span-2 text-lg mb-3 dark:text-white text-indigo-600">Questioners:</h2>
                ...
                <div class="flex items-center w-full">
                    ...
                    <p class="text-base mt-4 text-gray-400 font-normal dark:text-white"> {{ $d['interview_date'] }}
                ...
                <div class="group-hover:flex hidden ">
                    ...
                    <div class="group-hover:flex hidden bg-blue-700 flex-col absolute bottom-0 left-0 right-0 dark:bg-gray-900 overflow-hidden w-full h-1/3 transition duration-700 ease-in-out rounded-b-lg text-xs text-center text-white border-t-[1px] border-white">
                        <div class="flex justify-center mt-5">
                            <p class="mx-5 text-sm">Invite candidate to the Company</p>
                            @if ($d['status']!=="accepted")
                            <button type="submit" class="focus:outline-none w-[50px] h-[50px] text-gray-500 bg-white hover:bg-green-500 focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 border border-gray-200 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2" data-modal-toggle="rate-modal{{ $d['id'] }}">
                                Accept
                            </button>
                            @endif
                            @if ($d['status']!=="declined")
                            <button type="submit" class="focus:outline-none w-[50px] h-[50px] text-gray-500 bg-white hover:bg-red-500 focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-red-800 border border-gray-200 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2" data-modal-toggle="declined-modal{{ $d['id'] }}">
                                Decline
                            </button>
                            @endif
                        </div>
            ...
            <div id="editModal{{ $d['id'] }}" tabindex="-1" class="hidden  fixed top-0 right-0 left-0 z-50 md:inset-0 h-modal md:h-full">
                <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                    <div class="overflow-y-auto h-full relative bg-white rounded-lg dark:bg-slate-850 pt-4">
                ...
                <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                    <div class="relative bg-white rounded-lg shadow dark:bg-slate-850">
                        ...
                        <div class="p-6 text-center">
                            ...
                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to accept this Candidate?</h3>
                            <form method="POST" id="accept" action={{ route('interview.accept', $d['id']) }}>
                                @csrf
                                <div class="flex flex-cols-2 items-center justify-center">
                                <button data-modal-toggle="rate-modal{{ $d['id'] }}" type="submit" class="inline-block px-6 py-3 mr-3 font-bold text-center text-white uppercase align-middle transition-all bg-blue-500 rounded-lg cursor-pointer leading-normal text-xs ease-in tracking-tight-rem shadow-xs bg-150 bg-x-25 hover:-translate-y-px active:opacity-85 hover:shadow-md">
                                    Yes, I'm sure
                                </button>
                            </form>
                            <button data-modal-toggle="rate-modal{{ $d['id'] }}" type="button" class="inline-block px-6 py-3 mr-3 font-bold text-center text-white uppercase align-middle transition-all bg-gradient-to-tl from-red-600 to-orange-600 rounded-lg cursor-pointer leading-normal text-xs ease-in tracking-tight-rem shadow-xs bg-150 bg-x-25 hover:-translate-y-px active:opacity-85 hover:shadow-md">No, cancel</button>
                        </div>
                    </div> 
                    </div>
                </div>
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-slate-850">
                        ...
                        <div class="p-6 text-center">
                            ...
                            <form method="POST" id="decline" action={{ route('interview.decline', $d['id']) }}>
                                @csrf
                                <div class="flex flex-cols-2 items-center justify-center">
                                <button data-modal-toggle="declined-modal{{ $d['id'] }}" type="submit" class="inline-block px-6 py-3 mr-3 font-bold text-center text-white uppercase align-middle transition-all bg-gradient-to-tl from-red-600 to-orange-600 rounded-lg cursor-pointer leading-normal text-xs ease-in tracking-tight-rem shadow-xs bg-150 bg-x-25 hover:-translate-y-px active:opacity-85 hover:shadow-md">
                                    Yes, I'm sure
                                </button>
                            </form>
