                ...
                <div class="flex relative rounded-3xl bg-blue-900 mx-10 p-7">
                    <div class="flex-1">
                        <div class="flex">
                            ...
                            <h2 class="text-white ml-[35px] text-[25px] mt-[70px] font-[500]">Albert</h2>
                        </div>
                        <div class="mt-5">
                        ...
                        <div class="pt-3">
                            <span class="bg-blue-100 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800">HTML</span>
                    ...
                    {{-- <div class="flex flex-row-2 items-center rounded-lg md:flex-row ">
                        <div class="text-white justify-between p-4 leading-normal">
                            <img src="img/me-about.jpg" alt="profile" class="w-[150px] h-[200px] rounded-lg float-left">
                            <div class="flex text-center">
                            <h2 class="text-2xl font-bold pl-[15px] pt-[70px] tracking-tight">Albert</h2>
                            </div>
                            <div class="float-left">
                            
                            <p class="mb-3 w-[200px] font-normal">Since the beginning of my journey as a self-taught developer, I've been coding and creating freshly websites for clients around the world.</p>
                            </div>
                            ...
                            <div class="text-xs inline-flex items-center font-bold leading-sm uppercase px-3 py-1 bg-green-200 text-green-700 rounded-full">
                                <i class="fa-brands fa-react"> React JSX</i>
                                
                            </div>
                            <div class="text-xs inline-flex items-center font-bold leading-sm uppercase px-3 py-1 bg-green-200 text-green-700 rounded-full">
                                <i class="fa-brands fa-react"> HTML</i>
                               
                            </div>
                            <div class="text-xs inline-flex items-center font-bold leading-sm uppercase px-3 py-1 bg-green-200 text-green-700 rounded-full">
                                <i class="fa-brands fa-react"> CSS</i>
                                
                            </div>
                        </div>
                        </div>
                        <div class="flex flex-col pl-[60px]">
                            <button type="button" class="text-white bg-gradient-to-r from-cyan-500 to-blue-500 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm mb-5 px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Work with "name"</button>
                            <button type="button" class="text-white bg-gradient-to-r from-cyan-500 to-blue-500 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm mb-5 px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Remove from list</button>
                            <button class="block w-full md:w-auto text-white bg-gradient-to-r from-cyan-500 to-blue-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button" data-modal-toggle="small-modal">Add Comment</button>
                        </div>
                        <div id="small-modal" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
                            <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <!-- Modal body -->
                                    <div class="h-80 px-7 w-full rounded-[12px] bg-transparent-100 p-4">
                                        <textarea class="h-auto px-3 text-sm py-1 mt-5 outline-none border-pink-300 w-full resize-none border rounded-lg placeholder:text-sm" placeholder="Add your comments here"></textarea>  
                                        
                                        <div class="flex justify-between mt-2"> <button class="h-12 w-[150px] bg-blue-400 text-sm text-white rounded-lg transition-all cursor-pointer hover:bg-blue-600">Submit comment</button>
                                            <p class="text-sm text-blue-900 ">Enter atleast 15 characters</p>
                                        </div>   
                                    </div>
                                </div>
