                                              ...
                                              @csrf
                                                    ...
                                                    <div>
                                                      <label for="interview_id">Interview</label>
                                                        <select name="interview_id" id="interview_id" class="@error('interview_id') is-invalid @enderror capitalize bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white ">
                                                          <option class="capitalize" value="{{ $a -> id }}">{{ $a -> id }}</option>
                                                        </select>
                                                              @error('interview_id')
                                                              <div class="ml-1 text-red-500 text-xs alert alert-danger">{{ $message }}</div>
                                                          @enderror 
